...
set CLASSPATH=%APP_HOME%\lib\api.jar;%APP_HOME%\lib\core.jar;%APP_HOME%\lib\utils-1.3.5.jar;%APP_HOME%\lib\commons-lang3-3.10.jar


@rem Execute api
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %API_OPTS%  -classpath "%CLASSPATH%" multi.App %*
